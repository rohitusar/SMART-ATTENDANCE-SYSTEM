...
String data2;
const String data1 = "https://script.google.com/macros/s/AKfycbwtgG32r0PV26U8myq51j0hUvKvMunr_jVtLLxwT8aamZyCMSI4NPUc1MqGdTmVFDPaBA/exec?name=";
...
void setup() 
{
  ...
  WiFiMulti.addAP("GGSIPU_EDC_ADMIN", "Surajmal@12345");
